...
<div class="exportButton">
    ...
    &nbsp;&nbsp;&nbsp;
    <asp:Button ID="WordsExportButton" OnClientClick="return ButtonClicked();" runat="server" Text="Export to Word" OnClick="WordsExportButton_Click" />
    &nbsp;&nbsp;&nbsp;
    <asp:Button ID="PdfExportButton" OnClientClick="return ButtonClicked();" runat="server" Text="Export to PDF" OnClick="PdfExportButton_Click" />
</div>
