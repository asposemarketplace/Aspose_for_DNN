    ...
    public partial class Settings : AsposeDotNetNukeContentExportModuleSettingsBase
    {
        ...
        public override void LoadSettings()
        {
            try
            {
                if (Page.IsPostBack == false)
                {
                    ...
                    if (Settings.Contains("WordsExportButtonCssClass"))
                        WordsExportButtonCssClassTextBox.Text = Settings["WordsExportButtonCssClass"].ToString();

                    if (Settings.Contains("PdfExportButtonCssClass"))
                        PdfExportButtonCssClassTextBox.Text = Settings["PdfExportButtonCssClass"].ToString();
        ...
        public override void UpdateSettings()
        {
            try
            {
                ...
                //module settings
                modules.UpdateModuleSetting(ModuleId, "WordsExportButtonCssClass", WordsExportButtonCssClassTextBox.Text);
                modules.UpdateModuleSetting(ModuleId, "PdfExportButtonCssClass", PdfExportButtonCssClassTextBox.Text);
                ...
                //tab module settings
                modules.UpdateTabModuleSetting(TabModuleId, "WordsExportButtonCssClass", WordsExportButtonCssClassTextBox.Text);
                modules.UpdateTabModuleSetting(TabModuleId, "PdfExportButtonCssClass", PdfExportButtonCssClassTextBox.Text);
