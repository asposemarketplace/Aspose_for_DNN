...
namespace Aspose.CreateProjectWizard
{
    class IWizardImplementation : IWizard
    {
        ...
        private void ShowCustomForm()
        {
            ...
            installerForm.Text = ApplicationSettings.FormatString("Aspose DotNetNuke Project Templates");
        ...
        private static InstallerControl CreateWelcomeControl()
        {
            ...
            control.Title = ApplicationSettings.FormatString("Aspose DotNetNuke Project");
            control.SubTitle = ApplicationSettings.FormatString("Welcome to the Aspose DotNetNuke project creation wizard");
            return control;
        }
        ...
        internal static InstallProcessControl CreateProcessControl()
        {
            ...
            control.Title = "Aspose DotNetNuke Project";
